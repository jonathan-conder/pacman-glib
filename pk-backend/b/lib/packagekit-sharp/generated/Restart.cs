...
#region Autogenerated code
	public class Restart {
		...
		static extern IntPtr pk_restart_enum_to_string(int restart);

		public static string EnumToText(PackageKit.RestartEnum restart) {
			IntPtr raw_ret = pk_restart_enum_to_string((int) restart);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern int pk_restart_enum_from_string(IntPtr restart);
		...
		public static PackageKit.RestartEnum EnumFromText(string restart) {
			...
			int raw_ret = pk_restart_enum_from_string(native_restart);
