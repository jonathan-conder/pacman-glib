...
#region Autogenerated code
	public class Package {
		...
		[DllImport("libpackagekit-glib.dll")]
		static extern IntPtr pk_package_ids_from_string(IntPtr package_id);

		public static string IdsFromText(string package_id) {
			IntPtr native_package_id = GLib.Marshaller.StringToPtrGStrdup (package_id);
			IntPtr raw_ret = pk_package_ids_from_string(native_package_id);
			string ret = GLib.Marshaller.PtrToStringGFree(raw_ret);
			GLib.Marshaller.Free (native_package_id);
			return ret;
		}
		...
		[DllImport("libpackagekit-glib.dll")]
		static extern IntPtr pk_package_ids_to_string(IntPtr package_ids);

		public static string IdsToText(string package_ids) {
			IntPtr raw_ret = pk_package_ids_to_string(GLib.Marshaller.StringToPtrGStrdup(package_ids));
			string ret = GLib.Marshaller.PtrToStringGFree(raw_ret);
			return ret;
		}
