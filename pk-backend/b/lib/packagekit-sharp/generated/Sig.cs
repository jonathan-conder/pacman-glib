...
#region Autogenerated code
	public class Sig {
		...
		static extern IntPtr pk_sig_type_enum_to_string(int sig_type);

		public static string TypeEnumToText(PackageKit.SigTypeEnum sig_type) {
			IntPtr raw_ret = pk_sig_type_enum_to_string((int) sig_type);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern int pk_sig_type_enum_from_string(IntPtr sig_type);
		...
		public static PackageKit.SigTypeEnum TypeEnumFromText(string sig_type) {
			...
			int raw_ret = pk_sig_type_enum_from_string(native_sig_type);
