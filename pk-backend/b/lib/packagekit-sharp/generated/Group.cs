...
#region Autogenerated code
	public class Group {
		...
		static extern IntPtr pk_group_enum_to_string(int group);

		public static string EnumToText(PackageKit.GroupEnum group) {
			IntPtr raw_ret = pk_group_enum_to_string((int) group);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern ulong pk_group_bitfield_from_string(IntPtr groups);

		public static ulong BitfieldFromText(string groups) {
			IntPtr native_groups = GLib.Marshaller.StringToPtrGStrdup (groups);
			ulong raw_ret = pk_group_bitfield_from_string(native_groups);
			ulong ret = raw_ret;
		...
		[DllImport("libpackagekit-glib.dll")]
		static extern IntPtr pk_group_bitfield_to_string(ulong groups);

		public static string BitfieldToText(ulong groups) {
			IntPtr raw_ret = pk_group_bitfield_to_string(groups);
