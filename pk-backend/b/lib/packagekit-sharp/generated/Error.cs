...
#region Autogenerated code
	public class Error {
		...
		static extern IntPtr pk_error_enum_to_string(int code);

		public static string EnumToText(PackageKit.ErrorCodeEnum code) {
			IntPtr raw_ret = pk_error_enum_to_string((int) code);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern int pk_error_enum_from_string(IntPtr code);
		...
		public static PackageKit.ErrorCodeEnum EnumFromText(string code) {
			...
			int raw_ret = pk_error_enum_from_string(native_code);
