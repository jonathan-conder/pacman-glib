...
#region Autogenerated code
	public class Status {
		...
		static extern IntPtr pk_status_enum_to_string(int status);

		public static string EnumToText(PackageKit.StatusEnum status) {
			IntPtr raw_ret = pk_status_enum_to_string((int) status);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern int pk_status_enum_from_string(IntPtr status);
		...
		public static PackageKit.StatusEnum EnumFromText(string status) {
			...
			int raw_ret = pk_status_enum_from_string(native_status);
