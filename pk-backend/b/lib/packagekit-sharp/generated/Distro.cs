...
#region Autogenerated code
	public class Distro {
		...
		static extern int pk_distro_upgrade_enum_from_string(IntPtr upgrade);
		...
		public static PackageKit.DistroUpgradeEnum UpgradeEnumFromText(string upgrade) {
			...
			int raw_ret = pk_distro_upgrade_enum_from_string(native_upgrade);
		...
		[DllImport("libpackagekit-glib.dll")]
		static extern IntPtr pk_distro_upgrade_enum_to_string(int upgrade);

		public static string UpgradeEnumToText(PackageKit.DistroUpgradeEnum upgrade) {
			IntPtr raw_ret = pk_distro_upgrade_enum_to_string((int) upgrade);
