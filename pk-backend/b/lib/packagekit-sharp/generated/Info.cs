...
#region Autogenerated code
	public class Info {
		...
		static extern IntPtr pk_info_enum_to_string(int info);

		public static string EnumToText(PackageKit.InfoEnum info) {
			IntPtr raw_ret = pk_info_enum_to_string((int) info);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern int pk_info_enum_from_string(IntPtr info);

		public static PackageKit.InfoEnum EnumFromText(string info) {
			IntPtr native_info = GLib.Marshaller.StringToPtrGStrdup (info);
			int raw_ret = pk_info_enum_from_string(native_info);
