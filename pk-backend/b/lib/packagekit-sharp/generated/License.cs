...
#region Autogenerated code
	public class License {
		...
		static extern IntPtr pk_license_enum_to_string(int license);

		public static string EnumToText(PackageKit.LicenseEnum license) {
			IntPtr raw_ret = pk_license_enum_to_string((int) license);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern int pk_license_enum_from_string(IntPtr license);
		...
		public static PackageKit.LicenseEnum EnumFromText(string license) {
			...
			int raw_ret = pk_license_enum_from_string(native_license);
