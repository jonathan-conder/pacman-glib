...
#region Autogenerated code
	public class Message {
		...
		static extern IntPtr pk_message_enum_to_string(int message);

		public static string EnumToText(PackageKit.MessageEnum message) {
			IntPtr raw_ret = pk_message_enum_to_string((int) message);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern int pk_message_enum_from_string(IntPtr message);
		...
		public static PackageKit.MessageEnum EnumFromText(string message) {
			...
			int raw_ret = pk_message_enum_from_string(native_message);
