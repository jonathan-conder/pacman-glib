...
#region Autogenerated code
	public class Update {
		...
		static extern int pk_update_state_enum_from_string(IntPtr update_state);
		...
		public static PackageKit.UpdateStateEnum StateEnumFromText(string update_state) {
			...
			int raw_ret = pk_update_state_enum_from_string(native_update_state);
		...
		[DllImport("libpackagekit-glib.dll")]
		static extern IntPtr pk_update_state_enum_to_string(int update_state);

		public static string StateEnumToText(PackageKit.UpdateStateEnum update_state) {
			IntPtr raw_ret = pk_update_state_enum_to_string((int) update_state);
