...
#region Autogenerated code
	public class Provides {
		...
		static extern IntPtr pk_provides_enum_to_string(int provides);

		public static string EnumToText(PackageKit.ProvidesEnum provides) {
			IntPtr raw_ret = pk_provides_enum_to_string((int) provides);
			string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
			return ret;
		}

		[DllImport("libpackagekit-glib.dll")]
		static extern int pk_provides_enum_from_string(IntPtr provides);
		...
		public static PackageKit.ProvidesEnum EnumFromText(string provides) {
			...
			int raw_ret = pk_provides_enum_from_string(native_provides);
