...
class PackageKitEnum:
	...
	free_licenses = ( "unknown", "AAL", "Adobe", "ADSL", "AFL", "AGPLv1", "AMPAS BSD", "APSL 2.0", "ARL", "Arphic", "Artistic 2.0", "Artistic clarified", "ASL 1.0", "ASL 1.1", "ASL 2.0", "Baekmuk", "BitTorrent", "Boost", "BSD", "BSD with advertising", "CATOSL", "CC0", "CC-BY", "CC-BY-SA", "CDDL", "CDL", "CeCILL", "CeCILL-B", "CeCILL-C", "CNRI", "Condor", "Copyright only", "CPAL", "CPL", "Crystal Stacker", "DOC", "DSL", "dvipdfm", "ECL 1.0", "ECL 2.0", "eCos", "EFL 2.0", "Entessa", "EPL", "ERPL", "Eurosym", "EU Datagrid", "Fair", "FBSDDL", "Free Art", "FTL", "GeoGratis", "GFDL", "Giftware", "GL2PS", "Glide", "gnuplot", "GPLv1", "GPLv2", "GPLv2 or Artistic", "GPLv2+", "GPLv2+ or Artistic", "GPLv2+ with exceptions", "GPLv2 with exceptions", "GPLv3", "GPLv3+", "GPLv3+ with exceptions", "GPLv3 with exceptions", "GPL+", "GPL+ or Artistic", "GPL+ with exceptions", "IBM", "IEEE", "IJG", "ImageMagick", "iMatix", "Imlib2", "Intel ACPI", "Interbase", "IPA", "ISC", "Jabber", "JasPer", "JPython", "Knuth", "LBNL BSD", "LGPLv2", "LGPLv2+", "LGPLv2+ or Artistic", "LGPLv2+ with exceptions", "LGPLv2 with exceptions", "LGPLv3", "LGPLv3+", "LGPLv3+ with exceptions", "LGPLv3 with exceptions", "Liberation", "libtiff", "LLGPL", "Logica", "LPL", "LPPL", "mecab-ipadic", "MirOS", "MIT", "MIT with advertising", "mod_macro", "Motosoto", "mplus", "MPLv1.0", "MPLv1.1", "MS-PL", "Naumen", "NCSA", "NetCDF", "Netscape", "Newmat", "NGPL", "Nokia", "NOSL", "Noweb", "OAL", "OFL", "OFSFDL", "OpenLDAP", "OpenPBS", "OpenSSL", "OReilly", "OSL 1.0", "OSL 1.1", "OSL 2.0", "OSL 2.1", "OSL 3.0", "Phorum", "PHP", "Plexus", "psutils", "Public Domain", "Public Use", "Python", "Qhull", "QPL", "RiceBSD", "RPSL", "Ruby", "Saxpath", "SCEA", "SCRIP", "Sendmail", "SISSL", "Sleepycat", "SLIB", "SNIA", "SPL", "STIX", "TCL", "TMate", "TPL", "UCD", "Vim", "VNLSL", "VOSTROM", "VSL", "W3C", "Wadalab", "Webmin", "WTFPL", "wxWidgets", "XANO", "Xerox", "xinetd", "XSkat", "YPLv1.1", "Zend", "zlib", "zlib with acknowledgement", "ZPLv1.0", "ZPLv2.0", "ZPLv2.1", )
